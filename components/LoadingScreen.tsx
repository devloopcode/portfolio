...
const NAME         = "Mohamed Idbenouakrim";
const STAGGER      = 0.05;  // seconds between each letter
const TITLE_START  = 0.1;   // delay before first title letter
const NAME_START   = 0.55;  // delay before first name letter
  ...
  return (
    ...
    >
      ...
      <LetterByLetter
        ...
        duration={0.5}
        className="mt-3 font-(--font-heading) text-[clamp(30px,6vw,72px)] font-medium tracking-[-0.04em] leading-none text-(--fg)"
      />
